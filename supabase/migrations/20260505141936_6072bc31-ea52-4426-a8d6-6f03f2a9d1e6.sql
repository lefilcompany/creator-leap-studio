ALTER TABLE public.actions
  ADD COLUMN IF NOT EXISTS parent_action_id uuid REFERENCES public.actions(id) ON DELETE CASCADE;

CREATE INDEX IF NOT EXISTS idx_actions_parent_action_id
  ON public.actions(parent_action_id)
