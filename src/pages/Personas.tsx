...
const mockFullPersona: Persona = {
  ...
  description: "Profissional experiente em marketing digital, mãe de dois filhos, sempre em busca de produtos que facilitem sua rotina familiar.",
  goals: "Crescer profissionalmente, equilibrar vida pessoal e profissional, encontrar produtos que economizem tempo no dia a dia.",
  frustrations: "Falta de tempo, produtos que não cumprem o que prometem, dificuldade em conciliar trabalho e família.",
  behaviors: "Pesquisa muito antes de comprar, lê reviews, prefere compras online, muito ativa nas redes sociais.",
  channels: ["Instagram", "Facebook", "WhatsApp", "Email", "LinkedIn"],
  personalityTraits: "Organizada, determinada, cautelosa, sociável, orientada por resultados.",
  demographics: {
    gender: "Feminino",
  ...
  psychographics: {
    values: "Família, crescimento profissional, qualidade de vida, sustentabilidade.",
    interests: "Marketing digital, culinária, viagens, leitura, fitness.",
    lifestyle: "Vida urbana agitada, rotina estruturada, valoriza momentos em família."
  },
  createdAt: "2025-09-15T10:00:00.000Z",
