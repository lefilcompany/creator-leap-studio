                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select value={formData.colorPalette} onValueChange={value => setFormData(prev => ({ ...prev, colorPalette: value }))}>
                        <SelectTrigger id="advanced-color-palette" className="h-9 rounded-lg border-2 border-border/50 bg-background/50 text-xs"><SelectValue /></SelectTrigger>
                        <SelectContent>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={formData.lighting} onValueChange={value => setFormData(prev => ({ ...prev, lighting: value }))}>
                        <SelectTrigger id="advanced-lighting" className="h-9 rounded-lg border-2 border-border/50 bg-background/50 text-xs"><SelectValue /></SelectTrigger>
                        <SelectContent>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={formData.composition} onValueChange={value => setFormData(prev => ({ ...prev, composition: value }))}>
                        <SelectTrigger className="h-9 rounded-lg border-2 border-border/50 bg-background/50 text-xs"><SelectValue /></SelectTrigger>
                        <SelectContent>
                          <SelectItem value="auto">Automático</SelectItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          {formData.platform && platformSpecs[formData.platform] ? (
                            ...
                            <SelectItem value="1080x1080" disabled>Selecione uma plataforma primeiro</SelectItem>
                          )}
                        </SelectContent>
                      </Select>
                      {formData.width && formData.height && (
                        <p className="text-xs text-muted-foreground mt-1">Selecionado: {formData.width}x{formData.height}px</p>
                      )}
                    </div>
                  </div>
