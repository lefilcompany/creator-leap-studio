...
export const navbarSteps: Step[] = [
  ...
  },
  {
    ...
    content: 'Novo calendário: organize seu calendário editorial e planeje suas publicações estrategicamente.',
    placement: 'right',
  },
  {
...
export const planContentSteps: Step[] = [
  {
    target: '#plan-header',
    content: 'Bem-vindo ao Novo calendário! 📅 Esta funcionalidade usa IA para gerar um calendário editorial estratégico com ideias de posts alinhados à sua marca, tema e plataforma escolhida.',
    disableBeacon: true,
    placement: 'bottom',
  },
  {
