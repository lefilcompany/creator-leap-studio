...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-20 w-full shadow-lg shadow-primary/10 bg-card/95 backdrop-blur-md border-b border-border/20 transition-all duration-300 animate-fade-in flex-shrink-0">
