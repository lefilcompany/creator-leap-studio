...
export default function AccountManagement() {
  ...
  return (
    <>
      <Card className="shadow-lg border-0 bg-gradient-to-br from-card via-muted/[0.02] to-accent/[0.03]">
        <CardHeader className="bg-gradient-to-r from-destructive/8 via-accent/5 to-primary/8 border-b border-destructive/10 p-8">
          <div className="flex items-start gap-4">
            <div className="p-3 bg-gradient-to-br from-destructive/20 to-accent/20 rounded-2xl shadow-md">
        ...
        <CardContent className="space-y-6 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="border-0 bg-gradient-to-br from-muted/50 to-accent/5 hover:shadow-lg transition-all duration-300">
              <CardContent className="p-6 space-y-4">
                <div className="flex flex-col items-center gap-3 text-center">
                  <div className="p-4 bg-gradient-to-br from-muted to-accent/20 rounded-2xl shadow-md">
            ...
            <Card className="border-0 bg-gradient-to-br from-destructive/5 to-destructive/10 hover:shadow-lg transition-all duration-300">
              <CardContent className="p-6 space-y-4">
                <div className="flex flex-col items-center gap-3 text-center">
                  <div className="p-4 bg-gradient-to-br from-destructive/20 to-destructive/30 rounded-2xl shadow-md">
          ...
          <div className="border-t border-primary/10 pt-6">
            <Button
              ...
              className="w-full h-11 flex items-center justify-center gap-2 text-muted-foreground hover:text-foreground rounded-lg hover:bg-muted/50"
            >
