...
export default defineTool({
  ...
  description: "Lista as personas às quais o usuário autenticado tem acesso, com paginação e filtro por marca.",
  inputSchema: {
  ...
  handler: async ({ brand_id, search, limit, offset }, ctx) => {
    ...
    let q = supabase
      .from("personas")
      .select("id, name, brand_id, gender, age, location, main_goal, created_at", { count: "exact" })
